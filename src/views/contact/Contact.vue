...
<template>
 <main>
  <section class="get-in-touch custom-border-top">
   <h1>Vamos Conversar</h1>
   <p>
    Atualmente estou aberto a novas oportunidades, então eu adoraria saber mais sobre os seus projetos e como eu poderia te ajudar. <br />
    Fique à vontade para conhecer os meus perfis abaixo e para entrar em contato comigo através da próxima seção.
   </p>
   <ul class="social-media">
    <li class="footer-icon-github">
     <a href="https://github.com/Pedrohamoura-Git" target="_blank">
      <svg class="footer-icon-github" xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" viewBox="0 0 24 24">
       <path
        fill="#33323D"
    ...
    <li class="footer-icon-linkedin">
     <a href="https://www.linkedin.com/in/pedro-henrique-alves-moura-b27221210/" target="_blank">
      <svg class="footer__socials__social__icon" xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" viewBox="0 0 24 24">
       <path
        fill="#33323D"
    ...
    <li class="footer-icon-instagram">
     <a href="https://www.instagram.com/pedro.h.a.moura/" target="_blank">
  ...
  <section class="contact-me custom-border-top">
   ...
   <form action="https://formspree.io/f/mgerrojd" method="POST" id="contact-form">
    ...
    <div class="message-div">
     ...
     <textarea id="message-input" name="message" placeholder="Como posso ajudar?" required></textarea>
    </div>
    <br />
