...
// (V) - ADICIONAR ESTILO PARA CADA ROUTER-LINK CORRESPONDENTE A ROTA ATUAL,
// (V) - SUBIR O PROJETO PARA O NETLIFLY,
//  (V) - ADICIONAR TODOS OS NOMES NO ProjectNavbar,
//  (X) - FAZER OS NOMES ANIMADOS APARECEREM NA BUILD FINAL,
// () - CONFERIR SE O FORMULÁRIO ESTÁ FUNCIONANDO CORRETAMENTE,
//  () - FAZER O FORMULÁRIO FUNCIONAR,

// OPTIONALS 
// () - ADICIONAR O EFEITO DE E-MAIL ENVIADO,
